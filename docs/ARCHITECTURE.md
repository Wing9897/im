...
- **AI schedules never calendar-expand** — even `FREQ=SECONDLY` trigger strings must not enter month grids. Expand SQL + `may_calendar_expand_series` enforce this.
