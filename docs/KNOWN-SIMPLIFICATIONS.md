...
- **No config-class MCP tools** (tasks／sources／Actions／LLM／agent tick／system settings). No MCP create/delete workset. `web.search`／`tasks.consult_advisor` stay out of MCP.
