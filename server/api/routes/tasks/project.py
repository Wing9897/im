"""Project-tick status route: ``GET /api/v1/tasks/{id}/project-ticks``."""
...
from server.api.schemas.responses import ProjectTickStatusResponse
from server.errors import VALIDATION_ERROR, http_error
from server.services.project_tick_status import build_project_tick_status
...
async def project_tick_status(
    ...
    try:
        return await build_project_tick_status(get_db(request), task_id, limit=limit)
