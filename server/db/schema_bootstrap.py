...
Stamp **24** is the sole supported floor (``CURRENT_SCHEMA_VERSION``). There is
...
aggregated by ``schema.py``. Exact unstamped stamp-24
fingerprints are stamped (``PRAGMA user_version=24``). Every other non-empty
