...
async def test_fresh_database_auth_and_representative_routes(tmp_path) -> None:
    ...
    async with app.router.lifespan_context(app):
        ...
        assert await app.state.db.fetch_value("PRAGMA user_version") == CURRENT_SCHEMA_VERSION == 1
        ...
        async with AsyncClient(transport=transport, base_url="http://127.0.0.1") as client:
            ...
            representative_gets = {
                ...
                ("/api/v1/results/calendar?range_start=2026-01-01T00:00:00Z&range_end=2026-01-02T00:00:00Z"): list,
