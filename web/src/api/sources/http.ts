...
export function createHttpSource(
  ...
  return apiClient.post<AddHttpSourceResponse>("/api/v1/sources/http", params);
}
...
export function listHttpSources(): Promise<HttpSourceInfo[]> {
  return apiClient.get<HttpSourceInfo[]>("/api/v1/sources/http");
}
