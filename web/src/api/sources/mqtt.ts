...
export function createMqttBroker(
  ...
  return apiClient.post<AddMqttBrokerResponse>("/api/v1/sources/mqtt", params);
}
...
export function listMqttBrokers(): Promise<MqttBrokerInfo[]> {
  return apiClient.get<MqttBrokerInfo[]>("/api/v1/sources/mqtt");
}
