...
export const messageDetailBubbleClass =
  "min-h-12 whitespace-pre-wrap break-words rounded-[14px_14px_14px_4px] border border-[color-mix(in_srgb,var(--accent)_20%,var(--surface-border))] bg-[color-mix(in_srgb,var(--accent)_10%,var(--surface-panel))] p-[14px_16px] text-body leading-relaxed text-text-primary [&_pre]:m-0 [&_pre]:whitespace-pre-wrap [&_pre]:break-words [&_pre]:font-[inherit]";
