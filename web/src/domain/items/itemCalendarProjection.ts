 ...
 *
 * Occurrence projection lives on the server (`item_projection` →
 * `GET /calendar/window` for display and notify scan) and emits remind
 * floating all-day markers when remind_before_days is set.
