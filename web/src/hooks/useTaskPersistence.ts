...
import { analysisTaskToFormState, formStateToTaskConfig } from "../domain/tasks/taskFormUtils";
...
} from "../domain/tasks/chatEditorPersistedKeys";
...
export function useTaskPersistence({
  ...
  }, [taskId, tasks, tasksLoading, taskLoadError, setFormState, showToast]);
  ...
  }, [formState, taskId, isSaving, navigate, showToast, isMountedRef, onError, refreshTasks]);
